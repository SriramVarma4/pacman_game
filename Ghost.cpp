...
Ghost::Ghost(vector<SDL_Rect> blocks, vector<node> Nodes, int ID){
    ...
    case 1: mPosX = 1020; mPosY = 1020; count = 300; break;
    case 2: mPosX = 1800; mPosY = 1020; count = 900; break;
    case 3: mPosX = 1860; mPosY = 20; count = 1200; break;
    default:
...
{   
    ...
    int hdiff;
    count++;
    if(count == 1500 && state == 1) { count=0; state = -1; }
    else if(count == 300 && state == -1){count=0; state = 1;}
    switch (id){
    case 0:
